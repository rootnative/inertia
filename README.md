...
> **Status:** `0.0.3` — stable. The full declarative-core surface plus the layout and shared-element features are implemented and tested. Pre-`1.0.0`, minor breaking changes may still land and are called out in the changelog.
