...
<PackageManagerTabs packages="@onlynative/inertia-gestures react-native-gesture-handler" />
...
<PackageManagerTabs packages="@onlynative/inertia-svg react-native-svg" />
